...
public class GyroController : MonoBehaviour
{
    ...
    private readonly Quaternion landscapeRight = Quaternion.Euler(0, 3, 0);

    private readonly Quaternion landscapeLeft = Quaternion.Euler(0, -3, 0);

    private readonly Quaternion upsideDown = Quaternion.Euler(0, 0, 0);
